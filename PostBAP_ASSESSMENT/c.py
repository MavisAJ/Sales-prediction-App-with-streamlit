...
st.set_page_config(page_title="Time series annotations", page_icon="⬇", layout="centered")
...
def get_chart(data):
    ...
    lines = (alt.Chart(data, height=500, title="Evolution of stock prices")
    .mark_line().encode(
...
annotation_layer = (
    ...
    .encode(x="date:T",y=alt.Y("y:Q"),tooltip=["event"],).interactive())
# Display both charts together
